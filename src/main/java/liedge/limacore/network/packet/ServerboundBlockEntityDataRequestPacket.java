...
{
    static final PacketSpec<ServerboundBlockEntityDataRequestPacket> PACKET_SPEC = LimaCore.RESOURCES.packetSpec("block_entity_data_request", BlockPos.STREAM_CODEC.map(ServerboundBlockEntityDataRequestPacket::new, ServerboundBlockEntityDataRequestPacket::blockPos));
