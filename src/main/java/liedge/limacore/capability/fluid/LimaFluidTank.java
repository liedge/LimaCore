...
public class LimaFluidTank implements IFluidTank
{
    private FluidStack fluid;
    private int capacity;
    private int transferRate;

    public LimaFluidTank(FluidStack fluid, int capacity, int transferRate)
    {
        this.fluid = fluid;
    ...
    public LimaFluidTank(int capacity, int transferRate)
    {
